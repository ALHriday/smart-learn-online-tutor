        ...
        <Link className="w-full md:w-11/12 md:mx-auto" to='/find_tutors'>
            <div className=" grid-cols-2 grid md:grid-cols-3 gap-1 md:gap-2">
                {lang && lang.map((language, idx) =>
                    <div onClick={() => setSearch(language)} className="flex justify-evenly items-center border-collapse border rounded-md py-4 md:py-6 shadow-md hover:bg-slate-900 hover:text-white cursor-pointer" key={idx}>
